...
//
!function(){$("body").on("mouseenter",'[data-toggle="tooltip"]',function(event){$(this).tooltip("show")}).on("mouseleave",'[data-toggle="tooltip"]',function(event){$(this).tooltip("hide")}),moment.relativeTimeThreshold("s",60),moment.relativeTimeThreshold("m",60),moment.relativeTimeThreshold("h",24),moment.relativeTimeThreshold("d",28),moment.relativeTimeThreshold("M",12)}();
//
